 ...
 */
export async function findLogEntries( tag, searchString, startDate, endDate, levels, pageSize, pageNumber ) {
  ...
  const levelParams= noLevelCheck ? ['NULL'] : levels.map( level => {
